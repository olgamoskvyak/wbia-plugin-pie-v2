...
def parse_version(fpath='wbia_pie_v2/__init__.py'):
    """
...
DESCRIPTION = 'wbia_pie_v2 - An example ID plug-in for the WBIA system'
...
KWARGS = OrderedDict(
    ...
    use_scm_version={
        'write_to': 'wbia_pie_v2/_version.py',
        'write_to_template': '__version__ = "{version}"',
        'tag_regex': '^(?P<prefix>v)?(?P<version>[^\\+]+)(?P<suffix>.*)?$',
        'local_scheme': 'dirty-tag',
    },
    packages=find_packages(),
    package_dir={'wbia_pie_v2': 'wbia_pie_v2'},
